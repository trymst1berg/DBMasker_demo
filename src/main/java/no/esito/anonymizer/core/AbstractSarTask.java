 ...
 */
public abstract class AbstractSarTask extends AbstractWorkTask implements IChildren, IUpdateColumns {
    ...
    protected void traverseChild(IContext context, List<String> readcolumns, String[] row, CascadeSar sartable, String table) throws Throwable {
        String link = sartable.getLink(readcolumns, row);
        sarRecurse(context, sartable.getTable(), link, sartable.getChildren(), sartable.getChildColumns(), sartable.getAnonymizations(), sartable.getLabel(), sartable.getComment(), false);
    }
